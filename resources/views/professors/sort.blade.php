...
@section('title', 'Sorted Professors - ')
...
@section('content')
    ...
    <table style="border: 1px solid black;">
        <tr>
            ...
            <th style="border: 1px solid black; padding: 5px;"># of Reviews</th>
        ...
        <tr style="border: 1px">
            ...
            <td style="border: 1px solid black; padding: 5px;">{{ $professor->reviews_count }}</td>
        </tr>
        @endforeach
    </table>
    {{ $professors->links() }}
